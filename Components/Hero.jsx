          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                Crisis Chain <br className="hidden md:block" />
                Disaster Management Project
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam
                fuga fugit quisquam iusto velit fugiat doloribus rem veri
              </p>
              <a
                href="/"
                aria-label=""
                ...
                <form>
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button
                      ...
                      type="submit"
                      className="inline-flex items-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:outline-none newColor focus:shadow-outline"
                    >
                      Create
                    </button>
                  </div>
